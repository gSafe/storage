...
public class TestStorageClient_createContainer extends TestStorageClient {
    ...
    public void shouldRaiseAnException_IfServiceError() throws IOException, URISyntaxException {
        client.createContainer("bad");
    }

    @Test(expected = IllegalArgumentException.class)
    public void shouldRaiseAnException_IfContainerAlreadyExists() throws IOException, URISyntaxException {
        client.createContainer("AlreadyExists");
    }

    @Test
    public void shouldCreateContainer() throws IOException, URISyntaxException {
        client.createContainer("OkContainer");
        assertTrue(true);
    }
}
